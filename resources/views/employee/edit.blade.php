                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            name="firstName" id="firstName" value="{{ $employee->firstname }}" placeholder="Enter First Name">
                            @error('firstName')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            name="lastName" id="lastName" value="{{ $employee->lastname }}" placeholder="Enter Last Name">
                            @error('lastName')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            type="text" name="email" id="email" value="{{ $employee->email }}" placeholder="Enter Email">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            type="text" name="age" id="age" value="{{ $employee->age }}" placeholder="Enter Age">
                            @error('age')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="position" id="position" class="form-select">
                            ...
                            <option value="{{ $position->id }}" {{ $employee->id == $position->id ?'selected' : '' }}
